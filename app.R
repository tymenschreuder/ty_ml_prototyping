...
ui <- bootstrapPage(
  ...
  dashboardPage(
    ...
    dashboardSidebar(
      ...
      absolutePanel(
        ...
        width = '100%',
        height = 'auto',
        a(icon('github fa-2x'), href = 'https://github.com/davesteps/machLearn', target =
            '_blank')
      )
    ),
    dashboardBody(tabItems(
      tabItem(
        ...
        box(
          ...
          actionButton('btn_viewData', label = 'View Data', icon =
                         icon('table')),
          hr(),
          ...
          sliderInput(
            'sld_testsplit',
            label = label.help('Test set %', 'lbl_testsplit'),
            min = 33,
            max = 90,
            step = 1,
            value = 33
          ...
          bsTooltip(
            id = "lbl_testsplit",
            title = "% of data to set aside for test data",
            placement = "right",
            trigger = "hover"
          )
        ...
        box(
          ...
          selectizeInput(
            'yvar',
            label = label.help('y var', 'lbl_yvar'),
            choices = character(0)
          ),
          helpText(HTML(paste(
            'data type:', textOutput('Ytype')
          ))),
          bsTooltip(
            id = "lbl_yvar",
            title = "Variable to predict",
            placement = "right",
            trigger = "hover"
          ),
          hr(),
        ...
        box(
          ...
          selectizeInput(
            'xvar',
            label = label.help('X (Predict Y as function of):', 'lbl_xvar'),
            choices = character(0),
            multiple = T
          ),
          bsTooltip(
            id = "lbl_xvar",
            title = "Try and predict Y as function of these variables",
            placement = "right",
            trigger = "hover"
          )
        ),
      ...
      tabItem(
        ...
        column(
          ...
          box(
            ...
            selectizeInput(
              'slt_Tune',
              'Parameter Tuning' %>% label.help('lbl_Tune'),
            ...
            bsTooltip(
              id = "lbl_algo",
              title = "Which algorithms to test",
              placement = "right",
              trigger = "hover"
            ),
            bsTooltip(
              id = "lbl_Tune",
              title = "Type of tuning which is performed to optimize model parameters",
              placement = "right",
              trigger = "hover"
            ),
            bsTooltip(
              id = "lbl_CV",
              title = "Number of splits of training data used to tune parameters",
              placement = "right",
              trigger = "hover"
            )
      ...
      tabItem(
        ...
        column(
          ...
          box(
            ...
            helpText(
              'The best cross-validated model is selected by default.
              Multiple models can be selected to make ensemble predictions'
            ),
            bsTooltip(
              id = "lbl_Finalalgo",
              title = "Which algorithms to use to predict test",
              placement = "right",
              trigger = "hover"
            )
            
            ),
          valueBoxOutput('testsetS1', width =
                           12),
          valueBoxOutput('testsetS2', width =
                           12)
      ),
      box(
        width = 6,
        title = 'Test Set observed vs Predicted',
        solidHeader = T,
        status = 'primary',
  ...
  div(class = "busy",
      h4("working..."),
      h2(
        HTML('<i class="fa fa-cog fa-spin fa-2x"></i>')
      ))
)
